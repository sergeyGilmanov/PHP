...
<header>
	<nav>
		<?php
		$menu = [
            1 => '<div><a><span>Главная</span></a></div>',
            2 => '<div><a><span>Новости</span></a>',
            3 => [
                1 => '<div><a><span>Новости спорта</span></a>',
                2 => '<a><span>Новости о политике</span></a>',
                3 => '<a><span>Новости науки</span></a></div>',
            ],
            4 => '</div>',
            5 => '<div><a><span>О нас</span></a></div>',
            6 => '<div><a><span>Контакты</span></a></div>',
        ];
